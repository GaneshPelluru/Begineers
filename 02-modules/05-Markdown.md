...
- Note :some markdown editors or platforms may have specific ways of uploading images. For example, GitHub allows you to drag and drop images into the text editor, and it will automatically upload them and generate the appropriate syntax for you.
